...
namespace SWS
{
    ...
    public class bezierMoveEditor : moveEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Object.FindProperty("CameraMain"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("currentLookview"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("currentPoint"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("rotationDamping"));
